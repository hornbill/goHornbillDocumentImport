...
printf " ---- Building Document Import $versiond ---- \n"
...
do
    ...
    goarch=${split[1]}
    arch=${split[1]}
    output=goHornbillDocumentImport
    package=goHornbillDocumentImport
    ...
    zip -r "${package}_${os}_${arch}_v${version}.zip" $output LICENSE.md README.md doc*.csv > /dev/null
